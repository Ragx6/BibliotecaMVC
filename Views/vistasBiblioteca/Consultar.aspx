...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <asp:GridView ID="gvLibros" runat="server" AutoGenerateColumns="false"
            OnRowCommand="gvLibros_RowCommand" DataKeyNames="Codigo,Autor,FechaPublicacion" CssClass="styled-grid">
            <Columns>
                <asp:BoundField DataField="Codigo" HeaderText="Código" />
                <asp:BoundField DataField="Titulo" HeaderText="Título" />
                <asp:BoundField DataField="Autor" HeaderText="Autor" Visible="false" />
                <asp:BoundField DataField="FechaPublicacion" HeaderText="Fecha Publicación" DataFormatString="{0:yyyy-MM-dd}" Visible="false"/>
        ...
        <asp:Panel ID="pnlDetalles" runat="server" Visible="false">
            <asp:Label ID="lblDetalles" runat="server" />
        </asp:Panel>
